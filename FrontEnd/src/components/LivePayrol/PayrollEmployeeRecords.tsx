                        ...
                        {record.earnings_by_source && (
                          <div className="absolute left-0 top-full mt-2 z-50 hidden group-hover:block w-64 p-3 bg-white border border-gray-200 text-xs rounded-lg shadow-xl">
                            ...
                            <div className="space-y-1.5">
                              ...
                              {!!record.earnings_by_source.attendance.no_pay_allowance_adjustment && record.earnings_by_source.attendance.no_pay_allowance_adjustment > 0 && (
                                <div className="flex justify-between">
                                  <span className="text-gray-600">No-Pay Allowance Adj.:</span>
                                  <span className="font-medium text-red-600">-{formatCurrency(record.earnings_by_source.attendance.no_pay_allowance_adjustment)}</span>
                                </div>
                              )}
