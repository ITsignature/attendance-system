                ...
                {employees.length > 0 ? (
                  employees.map((employee) => (
                    ...
                    >
                      ...
                      <Table.Cell>
                        <div className="bg-green-50 dark:bg-green-900/20 px-3 py-2 rounded-lg border border-green-200 dark:border-green-700">
                          <div className="text-lg font-bold text-green-800 dark:text-green-200">
                            LKR {employee.base_salary ? employee.base_salary.toLocaleString() : 'Not Set'}
                          </div>
