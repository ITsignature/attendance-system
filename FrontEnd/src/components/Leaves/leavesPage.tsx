...
const LeavePage: React.FC = () => {
  ...
  const renderLoadingState = () => (
    <div className="p-3 sm:p-6 rounded-xl shadow-md bg-white dark:bg-darkgray">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 shrink-0 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center">
        ...
        <div className="sm:text-right pl-[52px] sm:pl-0">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <input
            ...
            className="flex-1 sm:flex-none px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          />
          <Button
            size="sm"
            color="gray"
